    ...
    _streamSubscriptions.add(
      userAccelerometerEventStream(samplingPeriod: sensorInterval).listen(
        (UserAccelerometerEvent event) {
          ...
          xAcc = _userAccelerometerEvent?.x ?? 0;
          yAcc = _userAccelerometerEvent?.y ?? 0;
          acc = sqrt(xAcc * xAcc + yAcc * yAcc);
          setState(() {
              ...
              barrierDismissible: true,
                ...
                builder: (BuildContext context) {
                  return AlertDialog(
                    ...
                    title: Text('G-Force: ${acc.toString()}'),
                  );
                });
          }
    ...
    return yoloResults.map((result) {
      ...
      return Positioned(
        ...
        child: Column(
          ...
          children: [
            Text(
              ((result["box"][3] - result["box"][1]) * factorY).toString(),
